...
class EnrollKrsScreen extends StatefulWidget {
  const EnrollKrsScreen({Key? key}) : super(key: key);

  @override
  State<EnrollKrsScreen> createState() => _EnrollKrsScreenState();
}

class _EnrollKrsScreenState extends State<EnrollKrsScreen> {
  @override
  void initState() {
